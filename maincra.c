...
int main() {
  ...
  for (size_t i = 0; i < 30; i++)// for para incializar el arreglo suma en 0
  {
    suma1[i]=0;
  }
  for (size_t i = 0; i < num_filas; i++)//for para el numero de elemento del array en suma1
  {
    for ( j = 0; j < aguante; j++)//for para que se recorra el arreglo diamantes
    {
  ...
  for (size_t i = 0; i < 30; i++)//for para comparar los valores en suma1
  {
